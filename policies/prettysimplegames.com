...
Pretty Simple pays attention to your personal data. Please read our Privacy Policy, in order to be aware of what type of information we collect, how we use/store/transfer it. Your use of the application signifies your agreement with our Privacy Policy.
This Privacy Policy may be amended from time to time. These modifications will be notified to you on http://www.prettysimplegames.com/privacy-policy. You are invited to look at this page periodically. Your continued use of the application will signify your acceptance of the changes.
...
We, as developers, also respect Facebook Principle and Policies. You can read them on http://developers.facebook.com/policy/.
If you have any questions, feel free to contact us at: contact@prettysimplegames.com.
WHAT WE COLLECT
First of all, the main aim of collecting personal data is to help us improve the game.
First, we collect Personal Information. By Personal Information, we mean data that identify you, such as name, address, telephone number, social security number, email, etc. We will not ask for all these data, but we may need some extra Personal Information for payment.
We harvest these data from Facebook, from You and from third parties.
Facebook: When you access the Game through Facebook, we may receive your basic account information (user ID, name, email, gender, birthday, current city, profile picture URL, and the user IDs of the user’s friends who have also connected with your application) from Facebook.
Please note again, that we abide by Facebook rules that manage the use of personal data.
You: You may want to share additional information with us. In that case, we may use the information you voluntarily give to us. We will not collect any personal data, except name and email.
Third Parties: We may call upon the services of third parties that may collect information about you. In that case, they may share these data with us, according to their own Privacy Policies. Please note that this Privacy Policy applies only for Pretty Simple, and that we are not responsible for Privacy Policies of other sites.
...
We do not collect information about Children under 13. In the event that such information was collect, we will delete this information as possible. You can contact us at:contact@prettysimplegames.com
...
We may disclose or access data about you if the law requires it (subpoena, court order, …) or if we have a good faith belief that it will avoid liability or fraud or to comply with legal process. This includes sharing data with companies or governments. Pretty Simple does not have to question such governmental process.
TRANSFER
In the event of an acquisition or merger, we may transfer your data to the new owner to keep the application working. Your information would be protected by any pre-existed privacy policy.
STORAGE, SECURITY AND MODIFICATIONS
We use means as secure as possible to protect your data. Data are stored in an external server protected behind a firewall.
For sensitive information such as credit card number or password, we use SSL encryption (Secure Socket Technology Layer).
...
Please note, that you can at any time modify your personal information thanks to your Facebook Profile.
You can also terminate at any time your account and ask for a complete delete of the data we have recorded about you. Please contact us at: contact@prettysimplegames.com.
...
Third party advertising companies serve ads on our site. We will not share data that can identify you personally. They may also use cookies or beacons (also called clear gifs) to manage the best their online advertising.
ADDITIONAL QUESTIONS
If you have any question, feel free to contact us at: contact@prettysimplegames.com.
